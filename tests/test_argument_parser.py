# -*- coding: utf-8 -*-
from app import library_injector
import unittest


class ArgumentParserTest(unittest.TestCase):
    def test_file(self):
        parsed_object = library_injector.parse_args(['main.cpp'])
    ...
    def test_action_param(self):
        ...
        parsed_object = library_injector.parse_args(
    ...
    def test_inplace_flag(self):
        ...
        parsed_object = library_injector.parse_args(['main.cpp', '--inplace'])
        self.assertEqual(parsed_object.file, 'main.cpp')
